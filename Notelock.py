...
b_savepass=Button(window,text="Save Password",height=2,width=50,bg="brown",fg="white",command=savepass)
...
b_clear=Button(window,text="Clear All",height=2,width=20,bg="brown",fg="white",command=clear)
b_clear.place(relx=0.9,rely=0.4,anchor=E)

####################################COMPLETE###################################################################

l1=Label(window,text="Developed By\nDEEPTHI VUNNAM",font=("arial",10,"bold"))
...
inputtxt1 = tk.Text(window,height=1,width=100)
...
inputtxt2 = tk.Text(window,height=1,width=100)
...
inputtxt3 = tk.Text(window,height=1,width=100)
